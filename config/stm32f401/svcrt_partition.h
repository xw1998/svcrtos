...
#define SVCRT_HW_COMPAT_ID   (0x40100004u)   /* 0x4010 = STM32F401; low 16 bits = image compat generation (4 = dynamic load + relocation). NOT the partition table ABI version - that one is SVCRT_PARTITION_VERSION in svcrt_share.h and may differ. */
