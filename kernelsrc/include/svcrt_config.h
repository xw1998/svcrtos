 ...
 *        不再根据CPU架构自动推导，因为同一架构可能有FPU/非FPU变体
 * ============================================================ */
 ...
 * MPU 内存保护单元配置
 * @brief 由板级配置文件根据实际硬件定义
 *        不再根据CPU架构自动推导，因为同一架构可能有MPU/非MPU变体
 * ============================================================ */
...
/* ============================================================
 * 共享内存配置
 * @brief 默认值可被板级配置覆盖，具体地址由 board 层
 *        svcrt_board_config.h 中定义
 * ============================================================ */
...
/* ============================================================
 * 系统主频配置
 * @brief 默认值可被板级配置覆盖，内核通过
 *        svcrt_port_get_system_clock() 获取实际主频，
 *        不直接依赖 SystemCoreClock 变量
 * ============================================================ */
...
/* ============================================================
 * 板级配置包含
 * @brief 通过编译选项 -DSVCRT_BOARD_CONFIG=<chip_header.h>
 *        包含板级配置文件，覆盖上述默认值
 * ============================================================ */
